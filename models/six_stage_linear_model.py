...
class ModelMaker:
    ...
    def create_models(self):        
        ...
        # PAF stages
        # stage 1
        stage1_output = self._make_stageI([stage0_output], "s1pafs", 96, self.PAF_NUM_FILTERS,"linear")
        # stage 2
        stage2_output = self._make_stageI([stage1_output, stage0_output], "s2pafs", 128, self.PAF_NUM_FILTERS,"linear")
        # stage 3
        stage3_output = self._make_stageI([stage2_output, stage0_output], "s3pafs", 128, self.PAF_NUM_FILTERS,"linear")
        # stage 4
        stage4_output = self._make_stageI([stage3_output, stage0_output], "s4pafs", 128, self.PAF_NUM_FILTERS,"linear")
        # keypoint heatmap stages
        # stage5
        stage5_output = self._make_stageI([stage4_output, stage0_output], "s5kpts", 96, self.HEATMAP_NUM_FILTERS,"relu")
        # stage6
        stage6_output = self._make_stageI([stage5_output, stage4_output, stage0_output], "s6kpts", 128, self.HEATMAP_NUM_FILTERS,"relu")
